// $ANTLR 3.4 Z:\\win7\\CI\\BuchstabenLoesung\\transformWalker.g 2015-01-14 09:28:15
...
public TreeAdaptor getTreeAdaptor() {
    ...
    public String getGrammarFileName() { return "Z:\\win7\\CI\\BuchstabenLoesung\\transformWalker.g"; }
    ...
    // $ANTLR start "prog"
    // Z:\\win7\\CI\\BuchstabenLoesung\\transformWalker.g:9:1: prog : ^( RAETSEL aufgabe aufgabe aufgabe aufgabe aufgabe aufgabe ) ;
    public final transformWalker.prog_return prog() throws RecognitionException {
        ...
        try {
            // Z:\\win7\\CI\\BuchstabenLoesung\\transformWalker.g:9:6: ( ^( RAETSEL aufgabe aufgabe aufgabe aufgabe aufgabe aufgabe ) )
            // Z:\\win7\\CI\\BuchstabenLoesung\\transformWalker.g:9:8: ^( RAETSEL aufgabe aufgabe aufgabe aufgabe aufgabe aufgabe )
            {
    ...
    // $ANTLR start "aufgabe"
    // Z:\\win7\\CI\\BuchstabenLoesung\\transformWalker.g:11:1: aufgabe : ( ^( EQUALS ( ^( PLUS wort wort ) ) wort ) | ^( EQUALS ^( MINUS w1= wort w2= wort ) w3= wort ) -> ^( EQUALS ^( PLUS[null, \"+\"] $w3 $w2) $w1) );
    public final transformWalker.aufgabe_return aufgabe() throws RecognitionException {
        ...
        try {
            // Z:\\win7\\CI\\BuchstabenLoesung\\transformWalker.g:11:9: ( ^( EQUALS ( ^( PLUS wort wort ) ) wort ) | ^( EQUALS ^( MINUS w1= wort w2= wort ) w3= wort ) -> ^( EQUALS ^( PLUS[null, \"+\"] $w3 $w2) $w1) )
            int alt1=2;
            ...
            switch (alt1) {
                case 1 :
                    // Z:\\win7\\CI\\BuchstabenLoesung\\transformWalker.g:11:11: ^( EQUALS ( ^( PLUS wort wort ) ) wort )
                    {
                    root_0 = (CommonTree)adaptor.nil();
                    ...
                    match(input, Token.DOWN, null); 
                    // Z:\\win7\\CI\\BuchstabenLoesung\\transformWalker.g:11:20: ( ^( PLUS wort wort ) )
                    // Z:\\win7\\CI\\BuchstabenLoesung\\transformWalker.g:11:21: ^( PLUS wort wort )
                    {
                    _last = (CommonTree)input.LT(1);
                    {
                    ...
                    break;
                case 2 :
                    // Z:\\win7\\CI\\BuchstabenLoesung\\transformWalker.g:12:4: ^( EQUALS ^( MINUS w1= wort w2= wort ) w3= wort )
                    {
                    _last = (CommonTree)input.LT(1);
                    {
                    CommonTree _save_last_1 = _last;
                    ...
                    {
                        // Z:\\win7\\CI\\BuchstabenLoesung\\transformWalker.g:12:50: ^( EQUALS ^( PLUS[null, \"+\"] $w3 $w2) $w1)
                        {
                        CommonTree root_1 = (CommonTree)adaptor.nil();
                        ...
                        // Z:\\win7\\CI\\BuchstabenLoesung\\transformWalker.g:12:59: ^( PLUS[null, \"+\"] $w3 $w2)
                        {
                        CommonTree root_2 = (CommonTree)adaptor.nil();
    ...
    // $ANTLR start "wort"
    // Z:\\win7\\CI\\BuchstabenLoesung\\transformWalker.g:15:1: wort : ^( WORT ( LETTER )+ ) ;
    public final transformWalker.wort_return wort() throws RecognitionException {
        ...
        try {
            // Z:\\win7\\CI\\BuchstabenLoesung\\transformWalker.g:15:7: ( ^( WORT ( LETTER )+ ) )
            // Z:\\win7\\CI\\BuchstabenLoesung\\transformWalker.g:15:9: ^( WORT ( LETTER )+ )
            {
            root_0 = (CommonTree)adaptor.nil();
            ...
            match(input, Token.DOWN, null); 
            // Z:\\win7\\CI\\BuchstabenLoesung\\transformWalker.g:15:16: ( LETTER )+
            int cnt2=0;
            loop2:
            do {
                int alt2=2;
